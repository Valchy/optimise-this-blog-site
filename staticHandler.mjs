...
let baseDir = process.env.NODE_ENV === 'production' ? 'dist' : 'src';

export default async function staticHandler(req, res, newBaseDir = 'src') {
	// To compare both development and production versions
	baseDir = newBaseDir;
